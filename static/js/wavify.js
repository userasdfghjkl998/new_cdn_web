...
function wavify(wave_element, options) {
  ...
  var settings = {
      ...
      // Amplitude of wave
      amplitude: options.amplitude?options.amplitude:100,
      // Animation speed
      speed: options.speed?options.speed:0.15,
      // Total number of articulation in wave
      bones: options.bones?options.bones:3,
      // Color
      color: options.color?options.color:"rgb(75,137,243)"
  };
    ...
    settings = Object.assign(
      {
          ...
          // Amplitude of wave
          amplitude: params.amplitude?params.amplitude:100,
          // Animation speed
          speed: params.speed?params.speed:0.15,
          // Total number of articulation in wave
          bones: params.bones?params.bones:3,
          // Color
          color: params.color?params.color:"rgb(75,137,243)"
      }
    );
  }
